...
def recieptCon():
    ...
    if(drinkVar.get() == 0 and appVar.get() == 0 and mainVar.get() == 0 and dessertVar.get() == 0):
        labelNothing = Label(recieptFrame,text = "Thanks\n For\n Wasting\n Our Time\n:)",bg="#F1F1E3", font=("Arial",30))
        labelNothing.pack()
    ...
    totalCost = round(total + tax,2)
    labelTax = Label(recieptFrame, text= "Tax-Total  --  " + str(tax),bg="#F1F1E3", font=("Beirut", 18))
    labelTax.pack()
    labelTotalCost = Label(recieptFrame, text= "Total-Cost  --  " + str(totalCost),bg="#F1F1E3", font=("Beirut", 18))
    labelTotalCost.pack()
